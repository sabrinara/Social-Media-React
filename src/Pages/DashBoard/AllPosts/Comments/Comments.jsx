...
const Comments = ({ postId }) => {
    ...
    return (
        <div>
            <div className="max-w-md mx-auto md:mt-8 p-4 border rounded-md shadow-md">
               <div className=''>
               <h2 className="text-lg font-semibold mb-4 text-center">{comments.length} Comments Here</h2>
